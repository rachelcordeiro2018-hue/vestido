...
const Login = () => {
  ...
  return (
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2 bg-slate-50">
      ...
      <div className="hidden lg:flex flex-col items-center justify-center bg-indigo-600 p-20 relative overflow-hidden">
        ...
        >
          ...
          <p className="text-indigo-100 text-lg max-w-md mx-auto mb-10 leading-relaxed font-light">
        ...
        <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-indigo-400/20 rounded-full blur-3xl"></div>
      </div>
